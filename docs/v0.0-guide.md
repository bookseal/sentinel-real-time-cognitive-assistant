# v0.0 — Minimal Volume Gauge: Complete Guide
...
# Pod logs (look for "Starting Sentinel v0.0")
...
> Snapshot of the `bithabit` k3s cluster at the time of v0.0 deployment.
...
sentinel.bit-habit.com     → sentinel (v0.0 — this app)
...
| Image | Size | Note |
|-------|------|------|
| sentinel (docker-compose build) | 5.88 GB | Old v0.1 build — **should delete** |
| viz-bit-habit:latest | 2.81 GB | |
| booktoss:latest | 2.13 GB | |
| sentinel:latest | 1.1 GB | Current v0.0 |
